...
`0.10.1` — **published, MCP live, all three organs semantic, SKILL-FIRST gate + actionability gate live, four bundled skills. Multi-vector MAX-pool retrieval live (ADR-0012): each skill scored by its best phrase point — 2.2× rank-1/separation over the bare single-vector index.**
