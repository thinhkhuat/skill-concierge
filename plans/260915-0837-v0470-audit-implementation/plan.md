...
| P6 | Ship: commit (openwiki guard), push, adapter installers (omp/dsh/cline/commandcode/zcode); handoff, journal, memory | — | [ ] |

## Acceptance

Gates in `.unlazy/v0470-impl/GATES.md` (G1–G8). R9 deferred by design; `/plugin marketplace update` (Claude Code, Codex) stays the owner's step.
